...
void GameState::handleInput(Game* game)
{
	...
	//if (kb.W) //Forward
	//	game->getPlayer().move(DirectX::XMFLOAT3(0.0f, 0.0f, 100.0f)); //Update with player speed
	//if (kb.S) //Backwards
	//	game->getPlayer().move(DirectX::XMFLOAT3(0.0f, 0.0f, -100.0f));
	//if (kb.A)	//Left
	//	game->getPlayer().move(DirectX::XMFLOAT3(-100.0f, 0.0f, 0.0f));
	//if (kb.D)	//Right
	//	game->getPlayer().move(DirectX::XMFLOAT3(100.0f, 0.0f, 0.0f));
